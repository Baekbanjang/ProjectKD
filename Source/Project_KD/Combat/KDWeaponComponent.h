...
#include "KDWeaponComponent.generated.h"

struct FEquipMontageSet;
class UKDWeaponDataAsset;
class UMeshComponent;

UCLASS(ClassGroup=(Weapon), meta=(BlueprintSpawnableComponent))
class PROJECT_KD_API UKDWeaponComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<UKDWeaponDataAsset> CurrentWeapon;
