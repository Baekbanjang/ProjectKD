...
#include "KDEnemyAnimInstance.generated.h"

class UKDHitFeedbackComponent;

// BoneShake 오프셋을 C++에서 계산. AnimBP child는 Modify Bone Translation 핀만 연결하면 됨.
UCLASS()
class PROJECT_KD_API UKDEnemyAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
private:
	UPROPERTY(Transient)
	TObjectPtr<UKDHitFeedbackComponent> CachedHitFeedback;
};
