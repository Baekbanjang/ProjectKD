...
#include "AbilitySystem/Abilities/Player/GA_PlayerTurn.h"
...
UGA_PlayerTurn::UGA_PlayerTurn()
{
	bRetriggerInstancedAbility = true;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
}

void UGA_PlayerTurn::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	PlayTask->OnCompleted.AddDynamic(this, &UGA_PlayerTurn::OnMontageCompleted);
	PlayTask->OnInterrupted.AddDynamic(this, &UGA_PlayerTurn::OnMontageInterrupted);
	PlayTask->OnCancelled.AddDynamic(this, &UGA_PlayerTurn::OnMontageCancelled);
	PlayTask->OnBlendOut.AddDynamic(this, &UGA_PlayerTurn::OnMontageBlendOut);
...
void UGA_PlayerTurn::OnCleanup(bool bWasCancelled)
{
...
void UGA_PlayerTurn::OnMontageCompleted()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UGA_PlayerTurn::OnMontageInterrupted()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UGA_PlayerTurn::OnMontageCancelled()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UGA_PlayerTurn::OnMontageBlendOut()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}
