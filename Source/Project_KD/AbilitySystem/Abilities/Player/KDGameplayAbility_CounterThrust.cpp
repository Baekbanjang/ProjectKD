...
#include "AbilitySystem/Abilities/Player/KDGameplayAbility_CounterThrust.h"
...
UKDGameplayAbility_CounterThrust::UKDGameplayAbility_CounterThrust()
{
	AbilityTags.AddTag(GameplayTags::Ability_Player_CounterThrust);
}

void UKDGameplayAbility_CounterThrust::OnActivated()
{
	Super::OnActivated();
