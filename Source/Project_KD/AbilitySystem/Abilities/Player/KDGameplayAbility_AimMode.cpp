...
#include "AbilitySystem/Abilities/Player/KDGameplayAbility_AimMode.h"

#include "Abilities/Tasks/AbilityTask_PlayMontageAndWait.h"
#include "Animation/AnimMontage.h"

UKDGameplayAbility_AimMode::UKDGameplayAbility_AimMode()
{
	bRetriggerInstancedAbility = false; // 어빌리티 재시작 여부
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
}

void UKDGameplayAbility_AimMode::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
void UKDGameplayAbility_AimMode::OnCleanup(bool bWasCancelled)
{
