...
#include "AbilitySystem/Abilities/Player/KDGameplayAbility_Dodge.h"
...
UKDGameplayAbility_Dodge::UKDGameplayAbility_Dodge()
{
	bRetriggerInstancedAbility = true;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
}

void UKDGameplayAbility_Dodge::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
	const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
    ...
    PlayTask->OnCompleted.AddDynamic(this, &UKDGameplayAbility_Dodge::OnMontageCompleted);
    PlayTask->OnInterrupted.AddDynamic(this, &UKDGameplayAbility_Dodge::OnMontageInterrupted);
    PlayTask->OnCancelled.AddDynamic(this, &UKDGameplayAbility_Dodge::OnMontageCancelled);
    PlayTask->OnBlendOut.AddDynamic(this, &UKDGameplayAbility_Dodge::OnMontageBlendOut);
...
void UKDGameplayAbility_Dodge::OnCleanup(bool bWasCancelled)
{
...
EDodgeDirection UKDGameplayAbility_Dodge::ResolveDodgeDirection() const
{
...
bool UKDGameplayAbility_Dodge::IsInPerfectDodgeWindow(const FGameplayAbilityActorInfo* ActorInfo) const
{
...
void UKDGameplayAbility_Dodge::OnMontageCompleted()
{
    EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UKDGameplayAbility_Dodge::OnMontageInterrupted()
{
    EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UKDGameplayAbility_Dodge::OnMontageCancelled()
{
    EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, true);
}

void UKDGameplayAbility_Dodge::OnMontageBlendOut()
{
    EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}
