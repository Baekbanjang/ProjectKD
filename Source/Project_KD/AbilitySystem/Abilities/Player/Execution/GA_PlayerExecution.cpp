...
#include "AbilitySystem/Abilities/Player/Execution/GA_PlayerExecution.h"
...
void UGA_PlayerExecution::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	Task->OnCompleted.AddDynamic(this, &UGA_PlayerExecution::OnFinisherDone);
	Task->OnInterrupted.AddDynamic(this, &UGA_PlayerExecution::OnFinisherDone);
	Task->OnCancelled.AddDynamic(this, &UGA_PlayerExecution::OnFinisherDone);
	Task->ReadyForActivation();
}

void UGA_PlayerExecution::OnCleanup(bool bWasCancelled)
{
	if (UAbilitySystemComponent* ASC = GetAbilitySystemComponentFromActorInfo())
	{
...
void UGA_PlayerExecution::OnFinisherDone()
{
