...
#include "AbilitySystem/Abilities/Player/GA_Parry.h"
                                ...
                                const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	HitListener->EventReceived.AddDynamic(this, &UGA_Parry::OnBlockHitReceived);
	...
	if (BlockStartMontage)
	{
		...
		if (StartTask)
		{
			StartTask->OnCompleted.AddDynamic(this, &UGA_Parry::OnBlockStartCompleted);
			StartTask->OnBlendOut.AddDynamic(this, &UGA_Parry::OnBlockStartCompleted);
			StartTask->OnInterrupted.AddDynamic(this, &UGA_Parry::OnBlockStartInterrupted);
			StartTask->OnCancelled.AddDynamic(this, &UGA_Parry::OnBlockStartInterrupted);
...
void UGA_Parry::OnCleanup(bool bWasCancelled)
{
...
void UGA_Parry::OnBlockStartCompleted()
{
	PlayBlockLoop();
}

void UGA_Parry::OnBlockStartInterrupted()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, true);
}

void UGA_Parry::OnBlockHitReceived(FGameplayEventData Payload)
{
	...
	if (HitTask)
	{
		...
		HitTask->OnCompleted.AddDynamic(this, &UGA_Parry::OnBlockHitMontageEnded);
		HitTask->OnBlendOut.AddDynamic(this, &UGA_Parry::OnBlockHitMontageEnded);
		HitTask->ReadyForActivation();
	}
}

void UGA_Parry::OnBlockHitMontageEnded()
{
	PlayBlockLoop();
}

void UGA_Parry::PlayBlockLoop()
{
