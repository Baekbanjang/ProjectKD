...
#include "AbilitySystem/Abilities/Enemy/KDGameplayAbility_EnemyMeleeTrace.h"
...
UKDGameplayAbility_EnemyMeleeTrace::UKDGameplayAbility_EnemyMeleeTrace()
{
...
void UKDGameplayAbility_EnemyMeleeTrace::OnActivated()
{
...
float UKDGameplayAbility_EnemyMeleeTrace::GetEffectiveMontagePlayRate() const
{
...
void UKDGameplayAbility_EnemyMeleeTrace::OnCleanup(bool bWasCancelled)
{
