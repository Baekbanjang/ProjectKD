#include "AbilitySystem/Abilities/Enemy/KDGameplayAbility_EnemyHitReact.h"
...
UKDGameplayAbility_EnemyHitReact::UKDGameplayAbility_EnemyHitReact()
{
...
void UKDGameplayAbility_EnemyHitReact::ActivateAbility(
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	Task->OnCompleted.AddDynamic(this, &UKDGameplayAbility_EnemyHitReact::OnMontageFinished);
	Task->OnInterrupted.AddDynamic(this, &UKDGameplayAbility_EnemyHitReact::OnMontageFinished);
	Task->OnCancelled.AddDynamic(this, &UKDGameplayAbility_EnemyHitReact::OnMontageFinished);
...
void UKDGameplayAbility_EnemyHitReact::OnMontageFinished()
{
