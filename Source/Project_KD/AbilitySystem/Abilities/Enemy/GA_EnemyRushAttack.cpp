...
#include "AbilitySystem/Abilities/Enemy/GA_EnemyRushAttack.h"
...
void UGA_EnemyRushAttack::OnActivated()
{
	...
	WarpListener->EventReceived.AddDynamic(this, &UGA_EnemyRushAttack::OnRushWarpEvent);
...
void UGA_EnemyRushAttack::OnRushWarpEvent(FGameplayEventData Payload)
{
...
void UGA_EnemyRushAttack::OnCleanup(bool bWasCancelled)
{
...
void UGA_EnemyRushAttack::UpdateWarpTarget()
{
