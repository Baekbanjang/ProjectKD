...
#include "AbilitySystem/Abilities/Enemy/KDGameplayAbility_EnemyRangedAttack.h"
...
void UKDGameplayAbility_EnemyRangedAttack::ActivateAbility(
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	MontageTask->OnCompleted.AddDynamic(this, &UKDGameplayAbility_EnemyRangedAttack::OnMontageCompleted);
	MontageTask->OnInterrupted.AddDynamic(this, &UKDGameplayAbility_EnemyRangedAttack::OnMontageInterrupted);
	MontageTask->OnCancelled.AddDynamic(this, &UKDGameplayAbility_EnemyRangedAttack::OnMontageInterrupted);
	...
	ReleaseTask->EventReceived.AddDynamic(this, &UKDGameplayAbility_EnemyRangedAttack::OnReleaseProjectile);
...
void UKDGameplayAbility_EnemyRangedAttack::OnReleaseProjectile(FGameplayEventData Payload)
{
...
void UKDGameplayAbility_EnemyRangedAttack::OnMontageCompleted()
{
	EndAbility(GetCurrentAbilitySpecHandle(), GetCurrentActorInfo(), GetCurrentActivationInfo(), false, false);
}

void UKDGameplayAbility_EnemyRangedAttack::OnMontageInterrupted()
{
