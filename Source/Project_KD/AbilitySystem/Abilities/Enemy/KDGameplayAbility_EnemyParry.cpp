...
#include "AbilitySystem/Abilities/Enemy/KDGameplayAbility_EnemyParry.h"
...
UKDGameplayAbility_EnemyParry::UKDGameplayAbility_EnemyParry()
{
	bRetriggerInstancedAbility = false;
	ParryClashCueTag = GameplayTags::GameplayCue_Combat_ParryClash;
}

void UKDGameplayAbility_EnemyParry::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
                                     const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	ParryHitListener->EventReceived.AddDynamic(this, &UKDGameplayAbility_EnemyParry::OnParrySuccess);
	...
	Task->OnCompleted.AddDynamic(this, &UKDGameplayAbility_EnemyParry::OnParryMontageEnded);
	Task->OnInterrupted.AddDynamic(this, &UKDGameplayAbility_EnemyParry::OnParryMontageEnded);
	Task->OnCancelled.AddDynamic(this, &UKDGameplayAbility_EnemyParry::OnParryMontageEnded);
...
void UKDGameplayAbility_EnemyParry::OnParryMontageEnded()
{
	if (!IsActive()) return;
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UKDGameplayAbility_EnemyParry::OnParrySuccess(FGameplayEventData Payload)
{
...
void UKDGameplayAbility_EnemyParry::OnCleanup(bool bWasCancelled)
{
