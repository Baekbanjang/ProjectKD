...
bool UAS_Combat::IsFrontalAttack(const FGameplayEffectModCallbackData& Data, UAbilitySystemComponent* ASC, float& OutHitAngle) const
{
...
bool UAS_Combat::TryInterceptByParry(const FGameplayEffectModCallbackData& Data, UAbilitySystemComponent* ASC,
...
float UAS_Combat::ApplyMitigation(UAbilitySystemComponent* ASC, float Damage) const
{
...
void UAS_Combat::SendHitReact(const FGameplayEffectModCallbackData& Data, UAbilitySystemComponent* ASC, bool bBlockedHit) const
{
	// 기능 : 히트리액션 신호
