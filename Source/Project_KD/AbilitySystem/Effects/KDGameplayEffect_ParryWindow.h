...
#include "KDGameplayEffect_ParryWindow.generated.h"
...
UCLASS()
class PROJECT_KD_API UKDGameplayEffect_ParryWindow : public UGameplayEffect
{
	GENERATED_BODY()

public:
	UKDGameplayEffect_ParryWindow();
};
