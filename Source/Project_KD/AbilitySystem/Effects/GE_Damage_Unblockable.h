...
#include "AbilitySystem/Effects/GE_Damage_Physical.h"
#include "GE_Damage_Unblockable.generated.h"
...
UCLASS()
class PROJECT_KD_API UGE_Damage_Unblockable : public UGE_Damage_Physical
{
	GENERATED_BODY()

public:
	UGE_Damage_Unblockable();
};
