...
#include "AbilitySystem/AnimNotifies/AN_Shoot.h"

#include "AbilitySystemBlueprintLibrary.h"
#include "KDGameplayTags.h"

void UAN_Shoot::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
...
FString UAN_Shoot::GetNotifyName_Implementation() const
{
	return TEXT("Shoot");
}
