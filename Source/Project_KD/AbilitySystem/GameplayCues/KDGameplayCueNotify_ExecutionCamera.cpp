...
#include "AbilitySystem/GameplayCues/KDGameplayCueNotify_ExecutionCamera.h"
...
AKDGameplayCueNotify_ExecutionCamera::AKDGameplayCueNotify_ExecutionCamera()
{
	bAutoDestroyOnRemove = true; // 큐 제거 시 GC 액터 정리
}

bool AKDGameplayCueNotify_ExecutionCamera::OnActive_Implementation(AActor* Target, const FGameplayCueParameters& Parameters)
{
...
bool AKDGameplayCueNotify_ExecutionCamera::OnRemove_Implementation(AActor* Target, const FGameplayCueParameters& Parameters)
{
