...
| # | 트리거 | 대상 | 비고 |
|---|--------|------|------|
| **T1** | Posture 게이지 **완전 소진 (0 도달)** → Stagger 상태 | 보스·엘리트만 | 세키로·검은 신화 오공식 자세 시스템 |
| **T2** | 적 점프 공격 직전 | 점프 공격 가능 적 (호위 무사·보스) | 패링 변형 |

> 📐 **용어**: Posture = 게이지(감소 수치) / Stagger = 상태(Posture 0 도달 시 진입). UI 표기는 [[기획/3_UI/3_UI]] §U-5 참조.
...
https://www.youtube.com/watch?v=nMhmtgxeibQ
### QTE 종료 후 상태
...
### 정리된 자료
- [[자료집/공중 QTE 자료집]] — 23개 자료 링크

### 레퍼런스 영상 검색 키워드
- "stellar blade air combo qte"
- "ff16 aerial combat slow motion"
- "DMC5 stinger air combo"
